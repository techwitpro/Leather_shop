...
const SimilarProduct = () => {
  ...
  return (
    <div className="mx-auto">
      <h1 className="leading-[100%] text-black text-[30px] sm:text-[32px] md:text-[48px] lg:text-[80px] font-normal tracking-normal russo text-start container mt-20 mb-20">Similler Products</h1>
